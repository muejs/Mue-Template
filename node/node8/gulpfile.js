...
var config = {
    ...
    watcher: {
        ...
        jsRule: [sourcePath + '/**/*.js', '!' + sourcePath + '/js/mue.js', '!' + sourcePath + '/js/zepto.js', '!' + sourcePath + '/js/platform/**/*.js', '!' + sourcePath + '/js/plugins/**/*.js', '!' + sourcePath + '/**/*.min.js', '!' + sourcePath + '/**/*.json'],
...
gulp.task('move-bui', function() {
    ...
    gulp.src([sourcePath + '/css/mue.css'])
        .pipe(gulp.dest(sourceBuild + '/css/'))
    gulp.src([sourcePath + '/js/mue.js'])
