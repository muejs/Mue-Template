    ...
    var bs = mue.store({
        ...
        methods: {
            ...
            fixKeyboard: function() {
                ...
                var count = 3;
                // 安卓键盘弹出的时间较长;
                var time = mue.platform.isIos() ? 200 : 400;
                // 为input绑定事件
        ...
        templates: {
            tplMessage: function(data) {
                ...
                data.forEach(function(item, index) {
                    ...
                    switch (type) {
                        case 0:
                            html += `<div class="mue-box-align-top chat-mine">
                              <div class="span1">
                                  <div class="mue-box-align-right">
                                      <div class="chat-content mue-arrow-right">
                                       ${content}
                                      </div>
                                  </div>
                              </div>
                            ...
                            break;
                        case 1:
                            html += `<div class="mue-box-align-top chat-target">
                              <div class="chat-icon"><img src="images/applogo.png" alt=""></div>
                              <div class="span1">
                                  <div class="chat-content mue-arrow-left">${content}</div>
                              </div>
                          </div>`
                            break;
                    }
