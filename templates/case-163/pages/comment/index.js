            ...
            var uiList = mue.list({
                ...
                template: function(data) {
                    ...
                    data.forEach(function(el, index) {
                        html += `<li class="mue-btn mue-box-align-top">
                          <div class="thumbnail"><img src="${el.image}" alt=""></div>
                          <div class="span1">
                              <h3 class="item-title"><span class="name">${el.name}</span><span class="digg mue-right">${el.digg} <i class="icons"><img src="images/digg.png" alt=""></i></span></h3>
